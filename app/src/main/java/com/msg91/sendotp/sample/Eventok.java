...
loadProducts();
    ...
    private void loadProducts() {
         ...
         * */
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/Vehicle_Managemen_system/new_tour_events.php",
