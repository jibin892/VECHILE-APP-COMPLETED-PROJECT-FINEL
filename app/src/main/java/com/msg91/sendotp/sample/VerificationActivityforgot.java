...
public class VerificationActivityforgot extends AppCompatActivity implements
...
private static final int OTP_LNGTH = 4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verificationforgot);

//        RelativeLayout constraintLayout = findViewById(R.id.topLayout1);
...
//                            .message("##OTP## is Your verification digits.")//##OTP## use for default generated OTP
    ...
    void initiateVerification(boolean skipPermissionCheck) {
        ...
        if (intent != null) {
           // DataManaer.getInstance().showProgressMessage(this,"");
             phoneNumber = intent.getStringExtra(MainActivity.INTENT_PHONENUMBER);
    ...
    public void onVerified(String response) {
        //DataManaer.getInstance().hideProgressMessage();
      startActivity(new Intent(VerificationActivityforgot.this,Resetpass.class).putExtra("num",phoneNumber));
    }
    ...
    private void startTimer() {
        resend_timer.setClickable(false);
        resend_timer.setTextColor(ContextCompat.getColor(VerificationActivityforgot.this, R.color.white));
        new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                resend_timer.setTextColor(ContextCompat.getColor(VerificationActivityforgot.this, R.color.send_otp_blue));
            }
        }.start();
    }
