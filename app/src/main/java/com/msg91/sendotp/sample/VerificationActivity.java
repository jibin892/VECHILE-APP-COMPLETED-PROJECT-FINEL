...
//        RelativeLayout constraintLayou = findViewById(R.id.topLayout);
//        AnimationDrawable animationDrawable = (AnimationDrawable) constraintLayou.getBackground();
