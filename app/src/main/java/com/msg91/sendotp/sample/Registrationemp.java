...
public class Registrationemp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registrationemp);

        ConstraintLayout constraintLayout = findViewById(R.id.rr);
       ...
       dob.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               datePickerDialog = new DatePickerDialog(Registrationemp.this,
...
//        }
            ...
            {
                Intent i=new Intent(getApplicationContext(), regtwoemp.class);
