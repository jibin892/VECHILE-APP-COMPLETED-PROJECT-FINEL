...
public class MainActivityforgot extends AppCompatActivity {
...
sh=getSharedPreferences("reg",MODE_PRIVATE);
  ...
  private void openActivity(String phoneNumber) {
    Intent verification = new Intent(this, VerificationActivityforgot.class);
  ...
  public void onButtonClicked(View view) {
    ...
    e.putString("ph",mPhoneNumber.getText().toString());
    e.apply();
