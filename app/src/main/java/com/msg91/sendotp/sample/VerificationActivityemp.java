...
public class VerificationActivityemp extends AppCompatActivity implements
...
private static final int OTP_LNGTH = 4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verificationemp);
...
//                            .message("##OTP## is Your verification digits.")//##OTP## use for default generated OTP
    ...
    public void onVerified(String response) {
        //DataManaer.getInstance().hideProgressMessage();
      startActivity(new Intent(VerificationActivityemp.this,Registrationemp.class).putExtra("num",phoneNumber));
    }
    ...
    private void startTimer() {
        resend_timer.setClickable(false);
        resend_timer.setTextColor(ContextCompat.getColor(VerificationActivityemp.this, R.color.white));
        new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                resend_timer.setTextColor(ContextCompat.getColor(VerificationActivityemp.this, R.color.send_otp_blue));
            }
        }.start();
    }
